      ...
      <div id="container2" v-else>
        <section>
          <div class="odpoved-container">
            ...
            <button class="buttons" @click="reloadNuxtApp">Restart</button>
          </div>
        </section>
      </div>
    </section>
...
async function sendMessage() {
  ...
  const response = await chatCompletion(message.value, 'gpt-3.5-turbo')
...
// QUESTIONS
  ...
  const questions = [
    {
      "question": "V Jakém kraji by jsi radši studoval/la?",
      "answer1": "Královehradecký/ Pardubický kraj",
      "answer1Total": "1",
      "answer2": "Olomoucký/ Moravskoslezský/ Zlínský kraj",
      "answer2Total": "2",
      "answer3": "Jihomoravský/ Jihočeský/ Vysočina kraj",
      "answer3Total": "3",
      "answer4": "Středočeský kraj / Praha",
      "answer4Total": "4",
      "answer5": "Plzeňský/ Karlovarský kraj",
      "answer5Total": "5",
      "answer6": "Ústecký/ Liberecký kraj",
      "answer6Total": "6"
    },
    {
    ...
    {
      "question": "Jsem radši osamotě",
      "answer1": "Plně souhlasím",
      "answer1Total": "1",
      "answer2": "Souhlasím",
      "answer2Total": "2",
      "answer3": "Nevím",
      ...
      "answer4": "Nesouhlasím",
      "answer4Total": "4",
      "answer5": "Plně nesouhlasím",
      "answer5Total": "5",
      "answer6": "Nevím",
      "answer6Total": "6"
    },
    {
      "question": "Ve skupině lidí jsem dominantní jedinec",
      "answer1": "Plně souhlasím",
      "answer1Total": "1",
      "answer2": "Souhlasím",
      "answer2Total": "2",
    ...
    {
      "question": "Užívám si osobní klid v přírodě.",
      "answer1": "Plně souhlasím",
      "answer1Total": "1",
      "answer2": "Souhlasím",
      "answer2Total": "2",
    ...
    {
      "question": "Jsem radši mezi lidmi.",
      "answer1": "Plně souhlasím",
      "answer1Total": "1",
      "answer2": "Souhlasím",
      "answer2Total": "2",
    ...
    {
      "question": "Rád zkouším nové věci.",
      "answer1": "Plně souhlasím",
      "answer1Total": "1",
      "answer2": "Souhlasím",
      "answer2Total": "2",
    ...
    {
      "question": "Miluju manuální práce.",
      "answer1": "Plně souhlasím",
      "answer1Total": "1",
      "answer2": "Souhlasím",
      "answer2Total": "2",
